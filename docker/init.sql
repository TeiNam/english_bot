-- 데이터베이스 생성
CREATE
DATABASE IF NOT EXISTS eng_base;
-- 기본 charset 설정
ALTER
DATABASE eng_base CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
USE
eng_base;
...
VALUES ('admin', '$pbkdf2-sha256$29000$yZlzbm3N2fvfW8tZ611rDQ$qXtiZPr/XBpR6TXRGqTpyFStnFpN0J/naB47DAsPvIU', 'admin',
        'Y', 'Y');
